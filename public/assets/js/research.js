...
const research = [
  {
    title: "Design of Pneumatic Valve Actuation System in IC Engine",
    authors:
      "PVVA system is designed for ic engine capable of proviing superiour performace compared to its comptetors ,This is achived by timely control of valve by STM 32 Microcontroller by embeded C programming, by utilizing inbuild registers and interrupt vector control and by DMA feature ,system interfacting and debuggung is done using python TTL library and mathlab",
    conferences:
      "",
    researchYr: 2022,
    citebox: "popup1",
    image: "https://hips.hearstapps.com/hmg-prod/amv-prod-cad-assets/wp-content/uploads/2016/01/Koenigsegg-Freevalve-Engine-1-626x381.jpg?resize=480:*",
    citation: {
      vancouver:
        "",
    },
    abstract:
      "Design of PVVA system for IC engine which is capable of reducing polluction and improving efficiency",
    absbox: "absPopup1",
  },
